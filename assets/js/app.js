...
/* harmony import */ var typesense_dist_typesense_min__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! typesense/dist/typesense.min */ "./node_modules/typesense/dist/typesense.min.js");
/* harmony import */ var typesense_dist_typesense_min__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(typesense_dist_typesense_min__WEBPACK_IMPORTED_MODULE_5__);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  var initTypesense = function initTypesense() {
    var searchClient = new typesense_dist_typesense_min__WEBPACK_IMPORTED_MODULE_5__.SearchClient({
      nodes: [{
  ...
  var openExternalLinksInDifferentTab = function openExternalLinksInDifferentTab() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().each(links, function (index, value) {
      if (!value.href.includes(window.location.hostname)) {
        if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(value).parents('#cookieblock', '#cookieblock__banner__wrapper', '#cookieblock__banner').length > 0) {
          value.target = '_self';
        } else {
          value.target = '_blank';
        }
          ...
          case 3:
            ...
            if (results.length > 0) {
              for (i = 0, len = results.length; i < len; i++) {
                ...
                htmlString += "\n          <article class=\"m-result\">            <a href=\"".concat(results[i].document.url, "\" class=\"m-result__link\">              <h3 class=\"m-result__title\">").concat(results[i].document.title, "</h3>              <span class=\"m-result__date\">").concat((0,_helpers__WEBPACK_IMPORTED_MODULE_8__.formatDate)(date), "</span>            </a>          </article>");
              }
...
/***/ "./node_modules/typesense/dist sync recursive":
/*!*******************************************!*\
  !*** ./node_modules/typesense/dist/ sync ***!
  \*******************************************/
/***/ ((module) => {
...
webpackEmptyContext.id = "./node_modules/typesense/dist sync recursive";
